                ...
                init: function () {
                    ...
                    $('.form_search').on('submit', function (e) {
                        ...
                        if (pageSearch) {
                            ...
                            const searchVal = document.querySelector('#querypage').value;
                            const searchForm = document.querySelector('.Middle_search .search');
                            if(searchVal === '') {
                                const error = document.createElement('span');
                                error.classList.add('Error-message');
                                error.textContent = 'Search is impossible, enter any word...';
